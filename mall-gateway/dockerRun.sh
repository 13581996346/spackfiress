...
BASE_PATH=/var/jenkins_home/workspace/mall/mall-gateway
...
function transfer(){
    echo "=========================>>>>>>>移动jenkins构建好的jar到Dockerfile所在目录，并重命名为test01.jar"
        ...
        mv /var/jenkins_mount/workspace/mall/mall-gateway/target/mall-gateway-0.0.1-SNAPSHOT.jar /home/jenkins_home/mall-gateway.jar
